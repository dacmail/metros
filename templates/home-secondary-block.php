<?php $block_posts = new WP_Query(array(
				'tax_query' => array(
					array(
						'taxonomy' => get_tax_by_term_id(get_post_meta(get_the_ID(), '_ungrynerd_block_2_tax', true)),
						'field'    => 'term_id',
						'terms'    => array(get_post_meta(get_the_ID(), '_ungrynerd_block_2_tax', true)),
					)
				),
				'posts_per_page' => get_post_meta(get_the_ID(), '_ungrynerd_block_2_count', true),
